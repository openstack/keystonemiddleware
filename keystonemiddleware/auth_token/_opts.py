...
_OPTS = [
    ...
    cfg.StrOpt("auth_version", help="API version of the Identity API endpoint."),
    cfg.StrOpt(
        "interface",
        default="internal",
    ...
    cfg.StrOpt(
        "certfile", help="Required if identity server requires client certificate"
    ),
    cfg.StrOpt(
        "keyfile", help="Required if identity server requires client certificate"
    ),
    cfg.StrOpt(
        "cafile",
    ...
    cfg.BoolOpt(
        ...
        default=True,
        help="(Optional) Use the advanced (eventlet safe) memcached client pool.",
    ),
    cfg.BoolOpt(
    ...
    cfg.StrOpt("memcache_username", default="", help="the user name for the SASL"),
    cfg.StrOpt("memcache_password", default="", help="the username password for SASL"),
]
