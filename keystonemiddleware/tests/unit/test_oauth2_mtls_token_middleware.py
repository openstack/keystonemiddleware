...
from keystonemiddleware.tests.unit.test_oauth2_token_middleware import (
    ...
    def setUp(self, expected_env=None, auth_version=None, fake_app=None):
        ...
        self.useFixture(
            fixtures.MockPatchObject(
                oauth2_mtls_token.OAuth2mTlsProtocol,
                "_create_oslo_cache",
...
class Oauth2mTlsTokenMiddlewareTest(
    BaseOauth2mTlsTokenMiddlewareTest, testresources.ResourcedTestCase
):
